...
export const CBC_LEVELS = [
    { code: 'EE', label: 'Exceeding Expectations', min: 80, color: 'text-emerald-600', bg: 'bg-emerald-50' },
    { code: 'ME', label: 'Meeting Expectations', min: 60, color: 'text-[#18216D]', bg: 'bg-amber-50' },
